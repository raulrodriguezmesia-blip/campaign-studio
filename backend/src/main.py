...
from opentelemetry_setup import campaigns_generated, images_generated, openai_api_errors, tracer
        ...
        for content in item.get("content", []):
            ...
            if content.get("type") == "text":
                ...
                try:
                    ...
                    continue
    # Fallback: parse the first raw text field from the first output item
    if data.get("output"):
